...
describe('Calculator', () => {
  ...
  it('should multiply 15 * 5 together correctly', () => {
    expect(calculator.multiply(15, 5)).to.equal(75);
  });
  it('should have an subtract function', () => {
    expect(calculator.subtract).to.exist;
  });

  it('should subtract 287 - 56 together correctly', () => {
    expect(calculator.subtract(287, 56)).to.equal(231);
  });
});